...
\begin{abstract}
  ...
  \MORUS[640], the same attack results in a correlation of $2^{-73}$, which does not threaten
...
%
  To identify this correlation, we make use of rotational symmetries in \MORUS
