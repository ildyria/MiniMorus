...
\begin{abstract}
  ...
  finalist.  There are three versions of \morus: \morus[640] with a
...
%
  ...
  \minimorus, where it yields a bias of $2^{-16}$.
...
%times, regardless of whether each encryption uses a different key.
  ...
  steps.  These additional results do not threaten full \morus, but
