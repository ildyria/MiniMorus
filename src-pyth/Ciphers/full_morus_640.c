...
// 	printf("%08x %08x %08x %08x %08x\n", state[0].f32[3], state[1].f32[3], state[2].f32[3], state[3].f32[3],
// 	       state[4].f32[3]);
// 	printf("%08x %08x %08x %08x %08x\n", state[0].f32[2], state[1].f32[2], state[2].f32[2], state[3].f32[2],
// 	       state[4].f32[2]);
// 	printf("%08x %08x %08x %08x %08x\n", state[0].f32[1], state[1].f32[1], state[2].f32[1], state[3].f32[1],
// 	       state[4].f32[1]);
// 	printf("%08x %08x %08x %08x %08x\n", state[0].f32[0], state[1].f32[0], state[2].f32[0], state[3].f32[0],
// 	       state[4].f32[0]);
// }
//
...
// }
//
// inline void print(state *saved_state, union Register *saved_cipher) {
// 	printf("-------------------------------------------- Ciphers\n");
...
// }
//
// inline void rotate_left_word(union Register *word, int bits) {
