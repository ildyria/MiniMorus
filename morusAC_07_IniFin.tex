...
\end{align*}
Those will lead to 4 matching bits after the 4-step forward computation and the 6-step backward computation. The analysis of the diffusion is given in \Cref{Tbl:ini_diffuse}. In the end, $K$ can be recovered faster than the exhaustive search by 1 bit, i.e.~with complexity $2^{127}$.
