...
\end{align}
It may be observed that the products occurring in the equation above involve 8 terms in a ring. The weight of this expression can be computed by brute force, and is equal to $3$.
