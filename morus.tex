...
\begin{figure}
  ...
  \begin{subfigure}{.3\textwidth}
    ...
    Step 1: $\beta_0, \alpha_{13}, \gamma_0, \delta_0$

    Step 2: $\alpha_7, \beta_{13}, \gamma_{13}$
    ...
    Step 2: $\alpha_{27,4,18}, \beta_7, \gamma_7, \varepsilon_0, \delta_7$

    Step 3: $\alpha_{19}, \beta_{6, 20}, \gamma_{20}$
