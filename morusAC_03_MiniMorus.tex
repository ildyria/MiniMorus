...
Because the trail we are going to build is relatively complex, we will first describe it on \MiniMORUS. We will then extend it to the full \MORUS via the previous symmetry.
