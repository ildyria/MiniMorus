...
The word-wise rotation constants $b_i$ for round $i$ are defined in \Cref{Tbl:rcon}.
...
The register-wise rotation constants $b_i'$ are also listed in \Cref{Tbl:rcon}.
...
\begin{table}[t]%[!bht]
  ...
  \begin{tabular}{@{}l@{\qquad}rrrrr rrrrr@{}}
    \toprule
    & \multicolumn{5}{@{}c@{~}}{Word-wise rotation $\lll_w$} & \multicolumn{5}{@{}c@{}}{Register-wise rotation $\lll$} \\
    \cmidrule(r){2-6}
    \cmidrule(l){7-11}
    & $b_0$  & $b_1$  & $b_2$  & $b_3$  & $b_4$  
    & $b_0'$ & $b_1'$ & $b_2'$ & $b_3'$ & $b_4'$  \\
