...
\todo{discuss \cite{sacryptMinaud14} on AEGIS \cite{AEGIS}}

\todo{linear cryptanalysis \cite{eurocryptMatsui93,eurocryptMatsuiY92}}

\todo{analysis of MORUS: \cite{secryptDwivediMW17,trustcomSalamSBDPW17,balkancryptsecMilevaDV15}}
